...
<span class="highlight-filename"><Link href="https://github.com/georgebyte/coffee-election/blob/master/src/app/store.ts">store.ts</Link></span>
...
<span class="highlight-filename">
    <Link href="https://github.com/georgebyte/coffee-election/blob/master/src/app/coffee-election.store.ts">
...
<span class="highlight-filename">
    <Link href="https://github.com/georgebyte/coffee-election/blob/master/src/app/coffee-election-state.ts">
...
<span class="highlight-filename"><Link href="https://github.com/georgebyte/coffee-election/blob/master/src/app/coffee-election.store.ts">coffee-election.store.ts</Link></span>
{/* {% highlight typescript linenos %}
@Injectable()
export class CoffeeElectionStore extends Store<CoffeeElectionState> {
constructor () {
...
<span class="highlight-filename"><Link href="https://github.com/georgebyte/coffee-election/blob/master/src/app/coffee-election.component.ts">coffee-election.component.ts</Link></span>
{/* {% highlight typescript linenos %}
@Component({ ... })
...
<span class="highlight-filename"><Link href="https://github.com/georgebyte/coffee-election/blob/master/src/app/coffee-election.component.html">coffee-election.component.html</Link></span>
...
<span class="highlight-filename"><Link href="https://github.com/georgebyte/coffee-election/blob/master/src/app/coffee-election.store.spec.ts">coffee-election.store.spec.ts</Link></span>
{/* {% highlight typescript linenos %}
