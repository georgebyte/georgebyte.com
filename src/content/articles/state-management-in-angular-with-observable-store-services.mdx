...
<ArticleNote label="Edit (March 20, 2019):">
    ...
    available here:{" "}
    <Link href="/blog/scalable-angular-app-architecture/">Scalable Angular app architecture</Link>.
</ArticleNote>
