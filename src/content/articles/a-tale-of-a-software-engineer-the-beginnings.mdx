...
<ArticleImage
    filename="george_byte_first_pc.jpeg"
    alt="George Byte's first PC"
    description="Rocking high fashion developer outfits from an early age."
/>
